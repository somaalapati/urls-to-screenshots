...
public class BlackBoard {
	...
	public void readExcel(String filePath, String fileName, String sheetName, int fileSeq, String failList, int index)
		...
		//index is nothing but the row number in the excel file. Sometimes screenshots are produced only for some rows. So
	...
	public void script1() throws IOException {		
		...
		readExcel(filePath, "URLs-Batch1.xlsx", "April06-2022", 1, "failedURLs_1.txt", 1);		
	}	
